...
//     pixels2.classList.remove('selected')

//     pixels3.classList.remove('selected')

//     pixels4.classList.remove('selected')

//     pixels5.classList.remove('selected')

//     pixels6.classList.remove('selected')

//     pixels7.classList.remove('selected')

//     pixels8.classList.remove('selected')

//     pixels9.classList.remove('selected')

//     pixels10.classList.remove('selected')

//     pixels11.classList.remove('selected')

//     pixels12.classList.remove('selected')

//     pixels13.classList.remove('selected')

//     pixels14.classList.remove('selected')

//     pixels15.classList.remove('selected')

//     pixels16.classList.remove('selected')

//     pixels17.classList.remove('selected')

//     pixels18.classList.remove('selected')

//     pixels19.classList.remove('selected')

//     pixels20.classList.remove('selected')

//     pixels21.classList.remove('selected')

//     pixels22.classList.remove('selected')

//     pixels23.classList.remove('selected')

//     pixels24.classList.remove('selected')

//     pixels25.classList.remove('selected')
...
//     pixels1.classList.remove('selected')
